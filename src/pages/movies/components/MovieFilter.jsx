    ...
    <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-4 mb-6 border border-gray-700/50">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-2">
          ...
          <h3 className="text-lg font-semibold text-white">Bộ lọc phim</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4">
        ...
        <div>
          ...
          >
            ...
            <option value="8">8.0+ ⭐ Rất hay</option>
            <option value="7">7.0+ ⭐ Hay</option>
            <option value="6">6.0+ ⭐ Ổn</option>
            <option value="5">5.0+ ⭐ Trung bình</option>
          </select>
        </div>
        ...
        <div>
          <select
            value={adult || ""}
            onChange={(e) => onAdultChange(e.target.value || null)}
            className="w-full bg-gray-700 text-white px-4 py-2 rounded-lg border border-gray-600 focus:border-red-500 focus:outline-none"
          >
            <option value="">Tất cả phim</option>
            <option value="false">Phim gia đình</option>
            <option value="true">Phim 18+</option>
          </select>
        </div>
      ...
      {/* Filter Summary */}
      {(selectedGenres.length > 0 || year || rating || adult) && (
